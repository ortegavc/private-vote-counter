...
final class Index {
    ...
    public function loadClass($name) {      
      $classes = array(        
        ...
        'ActaDao' => '../dao/ActaDao.php',
        'CandidatoDao' => '../dao/CandidatoDao.php',
        'OrgpoliticaDao' => '../dao/OrgpoliticaDao.php',
        'RecintoDao' => '../dao/RecintoDao.php',
        'UsuarioDao' => '../dao/UsuarioDao.php',
        'CandidatoMapper' => '../mapping/CandidatoMapper.php',
        'Candidato' => '../model/Candidato.php',
        'CandidatoSearchCriteria' => '../dao/CandidatoSearchCriteria.php',
        'Utils' => '../util/Utils.php',
        'SessionValidator' => '../validation/SessionValidator.php',
      );
    ...
    private function runPage($page, array $extra = array()) {
        ...
        if ($this->hasTemplate($page)) {
          ...
          if(SessionValidator::isLoguedIn()) {
            require self::LAYOUT_DIR . 'index.phtml';// main template (layout)
          } else {
            require self::LAYOUT_DIR . 'anony.phtml';
          }
        }
        if (!$run) {
